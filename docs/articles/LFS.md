...
#>    <chr>               <chr>   <chr>   <chr>           <chr>                    
#>  1 Labour Force Survey LFS     2026-04 3701            https://www150.statcan.g…
#>  2 Labour Force Survey LFS     2026-03 3701            https://www150.statcan.g…
#>  3 Labour Force Survey LFS     2026-02 3701            https://www150.statcan.g…
#>  4 Labour Force Survey LFS     2026-01 3701            https://www150.statcan.g…
#>  5 Labour Force Survey LFS     2025    3701            https://www150.statcan.g…
#>  6 Labour Force Survey LFS     2024    3701            https://www150.statcan.g…
#>  7 Labour Force Survey LFS     2023    3701            https://www150.statcan.g…
#>  8 Labour Force Survey LFS     2022    3701            https://www150.statcan.g…
#>  9 Labour Force Survey LFS     2021    3701            https://www150.statcan.g…
#> 10 Labour Force Survey LFS     2020    3701            https://www150.statcan.g…
#> # ℹ 14 more rows
```
...
By default the data is stored in the temporary session path, optionally
we can set the `canpumf.cache_path` option to a path to permanently
cache the data.

To convert to human readable column lables and column names we use the
`label_pumf_data` function.

``` r

lfs_2022 <- lfs_2022 |> label_pumf_data(rename_columns = TRUE) 
```

With this we can do some simple descriptive analysis. We could use the
`add_bootstrap_weights` function to add bootstrap wegihts if desired. We
