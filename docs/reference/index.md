...
- [`add_pumf_bootstrap_weights()`](https://mountainmath.github.io/canpumf/reference/add_pumf_bootstrap_weights.md)
...
- [`read_pumf_data()`](https://mountainmath.github.io/canpumf/reference/read_pumf_data.md)
...
- [`remove_pumf_bootstrap_weights()`](https://mountainmath.github.io/canpumf/reference/remove_pumf_bootstrap_weights.md)
