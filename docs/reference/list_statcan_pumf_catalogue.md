...
#> [1/5] Labour Force Survey: Public Use Microdata File (71M0001X)
#> [2/5] National Travel Survey microdata file (24250001)
#> [3/5] Visitor Travel Survey: Public use microdata file (24250002)
#> [4/5] Survey of Household Spending: Public Use Microdata File (62M0004X)
#> [5/5] Canadian Survey on Working Conditions: Public Use Microdata File (14250001)
#> # A tibble: 6 × 9
#>   catalogue_id Acronym SeriesTitle         Title survey_url edition format url  
#>   <chr>        <chr>   <chr>               <chr> <chr>      <chr>   <chr>  <chr>
#> 1 71M0001X     LFS     Labour Force Survey Labo… https://w… 2006    CSV    http…
#> 2 71M0001X     LFS     Labour Force Survey Labo… https://w… 2006    NA     http…
#> 3 71M0001X     LFS     Labour Force Survey Labo… https://w… 2007    CSV    http…
#> 4 71M0001X     LFS     Labour Force Survey Labo… https://w… 2007    NA     http…
#> 5 71M0001X     LFS     Labour Force Survey Labo… https://w… 2008    CSV    http…
#> 6 71M0001X     LFS     Labour Force Survey Labo… https://w… 2008    NA     http…
