...
```{r}
chs_pumf <- get_pumf("CHS","2018", refresh = TRUE) 
```
...
renter_chs_pumf <- chs_pumf |>
  filter((PDCT_05 == "No" & PPAC_05 == "10 or more years ago + Always lived here") | 
           (PPAC_05 != "10 or more years ago + Always lived here" & PPAC_30 == "Rent it"))
```
