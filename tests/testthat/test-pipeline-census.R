...
.census_supplement_warnings <- list(
  ...
  # 1981 individuals: WKACTMA/WKACTFA labels transposed in SPS (→ swap warning),
  # FAOCC81 code 17 injected via supplement, plus 1 blank PROV record (data artifact).
  "1981/individuals"     = "Variable PROV: \\d+ unmatched|absent from command files|labels swapped",
