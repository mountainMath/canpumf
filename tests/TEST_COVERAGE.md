...
| GSS (Caregiving) | `test-pipeline-gss.R` | 2018, 2012, 2007, 2002, 1996 | ✓ | ✓ | ✓ | 2007 warns "no French translation" for ~925/951 variables — allowed. 2002 = GSS cycle 16 ("Aging and Social Support"), a multi-module survey (MAIN + CG4 + CG6 + CR linked on RECID); primary module MAIN carries WGHT_PER; cycle/theme aliases resolve to "2002"; English-only code labels (bilingual parity skipped) |
...
| GSS (Education) | `test-pipeline-gss.R` | Education 2007, Education 1994 | ✓ | ✓ | ✓ | Education 2007 warns WTBS unlabeled; Education 2007 = same data as Caregiving 2007 |
| GSS (Time Use) | `test-pipeline-gss.R` | Time Use 2022, Time Use 2015, Time Use 2010, Time Use 1998 | ✓ | ✓ | ✓ | Multi-module: each cycle ships a respondent-level **Main** file plus an **Episode** file (one row per activity episode), built as two linked tables joining on the cycle key (PUMFID for 2022/2015, RECID for 2010/1998) via `pumf_module(tbl,"Episode")`; 2022 Episode uses force_numeric (ACTIVITY/LOCATION/TUI_01/TUI_03); Time Use 2010 warns WTBS_EPI unlabeled |
